        ...
        {data.map((item) => (
          ...
          >
            <div className="relative flex items-center justify-center h-60 md:h-57 lg:h-58 w-full shrink-0">
              ...
              <img
                className={`${item.imgClass} object-contain mt-10`}
                src={item.img}
                alt={item.name}
              />
            </div>
            <div className="w-full h-20 p-3 space-y-1 mt-6 border-t border-[#E8E8E8] shrink-0">
            ...
            <button
             ...
             text-[14px] sm:text-[16px] bg-[#28A745] w-full 
             h-10 min-h-10 rounded-b-xl shrink-0 mt-auto"
            >
